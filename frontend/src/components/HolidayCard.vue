...
const formattedDate = computed(() => formatDateRu(props.date))

function formatDateRu(inputDate) {
    if (!inputDate) return ''
    ...
    // normalize to local midnight to compute whole-day difference
    ...
    // pluralization helper for Russian: ['день','дня','дней']
